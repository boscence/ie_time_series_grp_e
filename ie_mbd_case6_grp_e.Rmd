...
First we compute the mean, standard deviation and the variance of the time series. We then plot the series and see the data is not stationary. The variance is different across the time series so can assume it is not stationary (is this right guys?). So we
```{r}
